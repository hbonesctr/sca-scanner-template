# Security Scan Report - Run 57

- Repository: `hbonesctr/sca-scanner-template`
- Branch/Ref: `dependabot/github_actions/actions/upload-artifact-7`
- Commit: `7cfd2c32802ac3a9756573b5c3ba0d8c38a0f775`
- Generated UTC: `2026-05-11T13:35:24.952392Z`
...
| Snyk Test | all-projects exit `unknown`, unmanaged exit `unknown` | `reports/snyk-results.json`, `reports/snyk-unmanaged-results.json` |
| Snyk Monitor | all-projects exit `unknown`, unmanaged exit `unknown` | `reports/snyk-monitor.log`, `reports/snyk-unmanaged-monitor.log` |
