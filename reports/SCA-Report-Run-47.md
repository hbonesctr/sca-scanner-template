# Security Scan Report - Run 47

- Repository: `hbonesctr/sca-scanner-template`
- Branch/Ref: `main`
- Commit: `a646a93d79fd82abcf51c72aa1730727f6a4f379`
- Generated UTC: `2026-05-09T14:22:01.655220Z`
...
| Snyk Test | all-projects exit `75`, unmanaged exit `75` | `reports/snyk-results.json`, `reports/snyk-unmanaged-results.json` |
| Snyk Monitor | all-projects exit `75`, unmanaged exit `75` | `reports/snyk-monitor.log`, `reports/snyk-unmanaged-monitor.log` |
